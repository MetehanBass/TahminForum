...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
        <a href="" style="margin-left:1%;" class="btn btn-secondary disabled">Yeni Konu Açmak için Giriş Yapın.</a>
      <hr>
      <table class="table table-borderless table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3"><a href="post.php?id=<?php echo $row['topicId'];?>&page=1"><b><?php echo ucwords($row['topic']) ?></b></a> <br>Konu içeriğinin belirli bir uzunluktaki kısmı 1.<br>
      ...
      <?php
      for($b=0;$b < $a;$b++) {
      ?> <a href="forum.php?id=<?php echo $gid ?>&page=<?php echo $b+1; ?>" style="text-decoration:none; color:rgb(143, 148, 83)"><b><?php echo $b+1;?></b></a> <?php
      }
       ?>
      <hr>
    </div>
