  ...
  <div class="row">
    ...
    <div class="container">
      <div class="col-md-12">
        ...
        for($b=0;$b < $a;$b++) {
        ?><a href="postlogged.php?id=<?php echo $gid ?>&page=<?php echo $b+1; ?>" style="text-decoration:none; color:rgb(143, 148, 83)"><b><?php echo $b+1;?></b></a> <?php
        }
         ?>

          <div class="col-md-12 offset-md-3">
              <form class="" action="addreply.php?id=<?php echo $_GET['id']; ?>" method="POST">
              ...
              <button style="margin-left:2%;align:center;"class="btn btn-primary" name="submit" type="submit">Yanıtı Gönder</button>
          </form>
        </div>
      </div>
    </div>
